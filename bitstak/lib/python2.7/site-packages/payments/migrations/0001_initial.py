...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'payments_transfer', (
            ...
            ('charge_gross', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=2)),
            ...
            ('net', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=2)),
        ...
        db.create_table(u'payments_currentsubscription', (
            ...
            ('trial_end', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('trial_start', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('amount', self.gf('django.db.models.fields.DecimalField')(max_digits=7, decimal_places=2)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
        ))
    ...
    models = {
        ...
        u'payments.currentsubscription': {
            ...
            'trial_end': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
        ...
        u'payments.transfer': {
            ...
            'charge_gross': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '7', 'decimal_places': '2'}),
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'net': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '7', 'decimal_places': '2'}),
